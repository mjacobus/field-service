...
RSpec.describe TerritoriesController do
  ...
  it 'should update territory' do
    patch :update, params: { id: @territory.to_param, territory: @territory_params }
  ...
  it 're-renders form on update error' do
    patch :update, params: { id: @territory.to_param, territory: @territory_params.merge(name: '') }
  ...
  it 'should destroy territory' do
    expect do
      delete :destroy, params: { id: @territory.to_param }
    end.to change { Territory.count }.by(-1)
